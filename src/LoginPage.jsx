...
const LoginPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      localStorage.setItem('preskool-user-name', user.displayName || loginInput);
      
      navigate('/role', { state: { role, email, loginName: user.displayName || loginInput } });
    } catch (err) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      localStorage.setItem('preskool-user-name', user.displayName);
      
      navigate('/role', { state: { role, email: user.email, loginName: user.displayName } });
    } catch (err) {
